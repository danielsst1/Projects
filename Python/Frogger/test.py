...
Car6 = (pygame.Rect(-550,550,100,50))
...
##    MOVESPEED = 50
##
##    drawText(text, font, windowSurface, (500), (350))
##    pygame.display.update()
    ...
    for i in range (len(set1)):        
        ...
        f += 1
        if set1[0].right < 0:
            set1[0] = Car1 = (pygame.Rect(650,600,100,50))
        if set1[1].right < 0:
            set1[1] = Car1 = (pygame.Rect(650,600,100,50))
        if set1[2].right < 0:
            set1[2] = Car1 = (pygame.Rect(650,600,100,50))
    g = 0
    for i in range (len(set3)):
        set3[g].left -= CARSPEED
        g += 1
        if set3[0].right < 0:
            set3[0] = Car1 = (pygame.Rect(700,500,100,50))
        if set3[1].right < 0:
            set3[1] = Car1 = (pygame.Rect(700,500,100,50))
        if set3[2].right < 0:
            set3[2] = Car1 = (pygame.Rect(700,500,100,50))
    h = 0
    for i in range (len(set5)):  
        set5[h].left -= CARSPEED
        h += 1
        if set5[0].right < 0:
            set5[0] = Car1 = (pygame.Rect(650,400,100,50))
        if set5[1].right < 0:
            set5[1] = Car1 = (pygame.Rect(650,400,100,50))
        if set5[2].right < 0:
            set5[2] = Car1 = (pygame.Rect(650,400,100,50))
